...
@Injectable()
export class MaxGreaterThanEqualConstraint implements ValidatorConstraintInterface {
...
export function MaxGreaterThanEqual(property: string, validationOptions?: ValidationOptions) {
